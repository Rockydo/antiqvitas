...
def generated_files() -> tuple[dict[str, str], int, int, int, int, Decimal, int, int]:
...
def main() -> int:
    ...
    failures: list[str] = []
    try:
        files, country_count, controlled, dependencies, pop_locations, pop_total, market_count, urban_count = generated_files()
