...
def m2_ages(timeline: dict[str, AntqDate], auc: bool = False) -> str:
    ages = (
        ("age_1_traditions", "age_principate", 0),
        ("age_2_renaissance", "age_high_empires", 1),
        ("age_3_discovery", "age_crisis", 2),
        ("age_4_reformation", "age_dominate", 3),
        ("age_5_absolutism", "age_migrations", 4),
    )
    blocks = [
    ...
    for key, timeline_key, victory_card in ages:
