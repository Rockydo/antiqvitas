...
VALIDATE_COMMANDS = (
    ...
    Command("tools/s2_frontier_politics_depth.py"),
    ...
    Command("tools/s2_cultural_integration.py", ("--check",)),
    ...
    Command("tools/s2_central_indian_granularity.py", ("--check",)),
    Command("tools/s2_mainland_sea_granularity.py", ("--check",)),
    Command("tools/s2_manchurian_granularity.py", ("--check",)),
    Command("tools/s2_bornean_granularity.py", ("--check",)),
    ...
    Command("tools/s2_sulawesi_maluku_granularity.py", ("--check",)),
    Command("tools/s2_plains_woodland_granularity.py", ("--check",)),
    Command("tools/s2_korean_peninsula_granularity.py", ("--check",)),
    Command("tools/s2_caucasian_granularity.py", ("--check",)),
    Command("tools/s2_andean_granularity.py", ("--check",)),
    Command("tools/s2_chibchan_granularity.py", ("--check",)),
    Command("tools/s2_final_placeholder_granularity.py", ("--check",)),
    ...
    Command("tools/s2_economy_chains.py", ("--check",)),
    ...
    Command("tools/r5_visible_unions.py", ("--check",)),
    Command("tools/r5_holy_sites.py", ("--check",)),
    Command("tools/m12_installed_content_census.py", ("--check",)),
    Command("tools/m11_advance_icons.py", ("--check",)),
    Command("tools/m11_advance_format.py", ("--check",)),
    ...
    Command("tools/s4_religion_profiles.py"),
    ...
    Command("tools/r5_tribal_buildings.py", ("--check",)),
    Command("tools/r5_productive_depth.py"),
    Command("tools/r5_settled_buildings.py", ("--check",)),
