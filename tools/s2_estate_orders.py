...
royal|antq_client_monarchy~antq_buffer_kingdom~antq_regional_kingship~antq_northern_indian_coin_kingship~antq_pundranagara_urban_kingship~antq_sogdian_city_compact~antq_dayuan_oasis_kingship~antq_han_western_regions_kingship~antq_petition_court~antq_frontier_muster_monarchy|royal_orders_atlas.png|03c5d29d261c2c10792377defa0d4ba5840e6f0427daeaa29f2c0b29a11852cd|P8.2;P8.3;P8.4;P8.5;P11;P13;CAH-XI;ASI-MITRA;UNESCO-MAHASTHAN;HAN-WR;IRAN-SOG-KANGJU|contested|The royal profile is a regional floor for incomplete evidence; it does not assert common titulature, succession, court offices, or tribute systems.|Royal Household~Dynastic and Regional Elites~Cult and Sanctuary Networks~Town and Caravan Houses~Rural Households~Frontier and Clan Communities
