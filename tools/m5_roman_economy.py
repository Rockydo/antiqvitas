...
FAMILIES_TO_ADD = (
    ...
    ("forum_basilica", "Forum Basilica", "A scalable civic-commercial hall for adjudication, contracts, exchange, and public business.", "government_category", "burghers", "trade_employment", "government_build_time", "local_max_control=0.02;local_monthly_control=0.001;local_distance_from_capital_speed_propagation=0.05;local_proximity_source=20;local_merchant_power=0.015", "stone=0.10;marble=0.04;lumber=0.05;tools=0.03", "stone;marble;lumber;tools", "Augustan Roman forum basilica interior with columned nave tribunal merchants wax tablets and restrained civic statuary"),
    ...
    ("cursus_mansio", "Cursus Publicus Mansio", "A scalable road station for official couriers, remounts, travelers, records, and state dispatches.", "government_category", "burghers", "trade_employment", "infrastructure_build_time", "local_max_control=0.02;local_monthly_control=0.001;local_distance_from_capital_speed_propagation=0.1;local_proximity_source=10;local_merchant_capacity=0.005", "lumber=0.08;livestock=0.06;leather=0.03;tools=0.03", "lumber;livestock;leather;tools", "Roman roadside mansio courtyard with milestone courier horse covered cart writing tablet and tiled lodging"),
    ("river_port", "River and Coastal Portus", "A scalable quay, landing, store, and handling space connecting inland supply to maritime markets.", "trade_category", "soldiers", "dock_employment", "medium_port_building_time", "local_merchant_capacity=0.015;local_sailors=0.0025", "lumber=0.12;naval_supplies=0.06;fiber_crops=0.04;tools=0.04", "lumber;naval_supplies;fiber_crops;tools", "Roman river portus with stone quay grain barge mast crane amphorae rope coils and warehouse frontage"),
