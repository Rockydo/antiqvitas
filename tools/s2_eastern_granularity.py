...
EXPECTED = {
    "PRZ": ("Greater-Poland Przeworsk", 35),
    "LPR": ("Lesser-Poland Przeworsk", 40),
    "ILM": ("Msta-Ilmen Late Dyakovo Horizon", 49),
    "PLH": ("Pskov-Luga Pottery", 51),
    "BLF": ("Beloe-Mologa Late Dyakovo Horizon", 33),
    "MOK": ("Moskva-Oka Late Dyakovo Culture", 59),
    "UVF": ("Nizhny-Novgorod Gorodets", 31),
    ...
    "SMD": ("Smolensk Dnieper-Dvina", 46),
    "RZM": ("Oka-Moksha Gorodets Culture", 45),
    "BLR": ("Upper Dnieper-Dvina Culture", 56),
    "NEM": ("Upper Neman Pottery", 39),
    "PDL": ("Podolian Lipița", 25),
    "RLG": ("Red-Ruthenian Lipița", 36),
    "DNP": ("Desna Zarubintsy", 39),
    "RBD": ("Right-Bank Zarubintsy", 39),
    "LBD": ("Left-Bank Zarubintsy", 23),
    ...
    "AKL": ("Forest-Steppe Altai Kulay", 21),
