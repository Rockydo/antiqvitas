...
FAMILIES_TO_ADD = (
    ...
    ("tesserae_kiln", "Mosaic-Cube Kiln", "A reusable kiln and sorting yard for colored glass and stone mosaic cubes.", "basic_industry_category", "local_production_efficiency=0.02", "glass=0.08;stone=0.08;clay=0.05;lumber=0.05;tools=0.03", "glass;stone;clay;lumber;tools", "Ancient mosaic-cube kiln with colored glass stone cubes clay bowls and small domed furnace"),
)
...
def main() -> int:
    ...
    if args.write:
        ...
        print("m5_eleventh_buildings: wrote 12 families; global placement delegated")
        return 0
    ...
    if stale:
        ...
        return 1
    print("m5_eleventh_buildings: PASS (12 families; global placement delegated)")
    return 0
