...
EXPECTED = {
    "LZC": ("Northwest Luzon Coastal Communities", "binalatongan", "samtoy_province", 4, "antq_northwest_luzon_coast", "antq_philippine_coastal_river_network"),
    "CXR": ("Central Luzon River Communities", "pulilan", "pampanga_province", 5, "antq_central_luzon_river", "antq_philippine_coastal_river_network"),
    "MBL": ("Manila Bay-Laguna Communities", "maynila", "katagalugan_province", 6, "antq_manila_bay_laguna", "antq_philippine_coastal_river_network"),
    "BCP": ("Bicol Peninsula Metal-Age Communities", "naga_bikol", "ibalong_province", 6, "antq_bicol_peninsula_metal_age", "antq_philippine_coastal_river_network"),
    "MDR": ("Mindoro Maritime Communities", "kalapang", "mait_province", 4, "antq_mindoro_maritime", "antq_philippine_cave_coast_network"),
    "PNY": ("Panay Metal-Age Communities", "irong_irong", "panay_province", 5, "antq_panay_metal_age", "antq_philippine_mortuary_community_network"),
    "NGR": ("Negros Metal-Age Communities", "tanjay", "buglas_province", 4, "antq_negros_metal_age", "antq_philippine_mortuary_community_network"),
    "CBH": ("Cebu-Bohol Island Communities", "singhapala", "central_visayas_province", 4, "antq_cebu_bohol_island", "antq_philippine_island_exchange_network"),
    "PLW": ("Palawan Cave-Coast Communities", "taytay", "palawan_province", 3, "antq_palawan_cave_coast", "antq_philippine_cave_coast_network"),
    "AGS": ("Agusan River Communities", "butuan", "agusan_province", 6, "antq_agusan_river", "antq_philippine_coastal_river_network"),
    "LNO": ("Lanao Coast-Lake Communities", "malabang", "agus_province", 3, "antq_lanao_coast_lake", "antq_philippine_coastal_river_network"),
    "PCT": ("Pulangi-Cotabato Basin Communities", "kuta_watu", "mindanao_province", 8, "antq_pulangi_cotabato_basin", "antq_philippine_coastal_river_network"),
    "MTT": ("Maitum-Sarangani Mortuary Communities", "makar", "tagloc_province", 2, "antq_maitum_sarangani", "antq_philippine_mortuary_community_network"),
    "ZBG": ("Zamboanga Peninsula Communities", "samboangan", "zamboanga_province", 6, "antq_zamboanga_peninsula", "antq_philippine_coastal_river_network"),
    "SLU": ("Sulu Island Communities", "maimbung", "sulu_province", 3, "antq_sulu_island", "antq_philippine_island_exchange_network"),
}
FIELDS = (
