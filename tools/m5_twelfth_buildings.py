...
FAMILIES_TO_ADD = (
    ...
    ("materia_medica", "Medicinal Compounding Workshop", "A reusable specialist workshop for mineral and animal-derived medicinal compounds.", "consumer_goods_category", "local_life_expectancy=0.01", "mercury=0.02;ivory=0.05;tools=0.03", "mercury;ivory;tools", "Ancient medicinal compounding workshop with stone mortar dried roots ceramic jars and small scales"),
)
