...
`docs/culture_remap.csv` ledger supplies 47 source-labelled area/province
selectors, resolving to 1,406 controlled locations and 22 additional culture
...
coasts, South Arabia, and northeast Africa. Its contested rows record broad
proxies rather than uniform ethnic boundaries. It raises the catalogue to 91,
not the plan's final 350-500 cultures.
