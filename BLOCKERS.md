...
`docs/culture_remap.csv` ledger supplies 121 source-labelled area/province
selectors, resolving to 4,208 controlled locations and 33 additional culture
...
Scandinavia, Finland, the Baltic, South Asia, and Southeast Asia. Its
contested rows record broad proxies rather than uniform ethnic boundaries. It
raises the catalogue to 102, not the plan's final 350-500 cultures.
