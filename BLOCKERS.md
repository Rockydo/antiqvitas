...
`docs/culture_remap.csv` ledger now supplies 324 source-labelled geographic
selectors, resolving 12,011 controlled locations across 149 distinct mapped
...
and Kama-Perm archaeological-linguistic contexts.
