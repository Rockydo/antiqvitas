...
`docs/culture_remap.csv` ledger supplies 197 source-labelled geographic
selectors, resolving to 6,555 controlled locations and 60 additional culture
...
Americas, and the controlled Oceanian surface.
Its contested rows record broad proxies rather than uniform ethnic boundaries.
It raises the catalogue to 129, not the plan's final 350-500 cultures.
