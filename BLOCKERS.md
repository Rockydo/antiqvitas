...
`docs/culture_remap.csv` ledger supplies 93 source-labelled area/province
selectors, resolving to 2,888 controlled locations and 22 additional culture
...
Scandinavia, Finland, and the Baltic. Its contested rows record broad proxies
rather than uniform ethnic boundaries. It raises the catalogue to 91, not the
plan's final 350-500 cultures.
