...
The roster contains **117** ancient unit types, including **22** reviewed mercenary companies. The M7 validator fails if a listed core type loses its bounded country availability, a required company or tactical profile disappears, or a core AD 1 seed no longer contains every required role.
