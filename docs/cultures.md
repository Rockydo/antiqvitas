...
The generated catalogue currently contains 125 culture definitions across the
...
finished 350-500 culture target. Its first seven source-led location batches
use 191 selectors to resolve 6,543 controlled locations through
