...
The generated catalogue currently contains 107 culture definitions across the
...
finished 350-500 culture target. Its first four source-led location batches
use 146 selectors to resolve 5,301 controlled locations through
