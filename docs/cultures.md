...
The generated catalogue currently contains 102 culture definitions across the
...
finished 350-500 culture target. Its first three source-led location batches
use 121 selectors to resolve 4,208 controlled locations through
