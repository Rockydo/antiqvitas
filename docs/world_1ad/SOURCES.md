...
- `CTP-HR`: *Han Shu*, ["Wang Mang zhuan shang"](https://ctext.org/han-shu/wang-mang-zhuan-shang/ens), used for Zhen Feng, Zhen Han, Ping Yan, and Liu Xin as named actors in Wang Mang's active regency circle, with the first Yuan Shi-year decree separately naming the two Zhens. It supports court records, not a reconstruction of every office term, personal ability, or engine regency role.
