...
- [x] Replace generic Roman civic/economic proxies with a source-led named building pass: 26 direct-icon specials now cover water, public grain storage, Forum Romanum/Augusti, Basilica Aemilia, macellum, Horrea Galbana, baths, Theatre of Marcellus, Mars Ultor cult, Tabularium, Circus, mint, workshops, mill/bakery, Villa Liviae, the Pantheum, Saepta, Diribitorium, the Palatine Temple of Apollo and library, Curia Iulia, Porticus Octaviae, the naval bases at Rome and Ravenna, and the Mogontiacum frontier camp. See `docs/m5/roman_buildings.csv` and `M5_ROMAN_CIVIC_BUILDINGS.md`.
