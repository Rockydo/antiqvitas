...
For the current ledger, 1,809 of 2,415 placements (74.9%) use calibrated productive
guild recipes. The remaining 606 placements are intentionally bounded civic,
...
are the sole one-level exception set, leaving 95.8% of all
