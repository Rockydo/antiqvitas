...
For the current ledger, 212 of 330 placements (64.2%) use calibrated productive
guild recipes: wine, pottery, cloth, glass, dyes, tools, or naval supplies.
The remaining 118 placements are intentionally bounded civic, religious,
infrastructure, service, primary-production, or fort contexts. This is within
the requested 50-80% productive range.

All 264 regional-family placements render as non-special, repeatable guild
buildings with `guild_max_level`. The 62 named historic/civic placements and
four M7 fort proxies are the sole one-level exception set, leaving 80.0% of all
