...
For the current ledger, 1,497 of 1,912 placements (78.3%) use calibrated productive
guild recipes. The remaining 415 placements are intentionally bounded civic,
