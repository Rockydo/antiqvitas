...
For the current ledger, 1,497 of 1,911 placements (78.3%) use calibrated productive
...
buildings with `guild_max_level`. The 107 named historic/civic or fort proxies
are the sole one-level exception set, leaving 94.4% of all
