...
For the current ledger, 319 of 455 placements (70.1%) use calibrated productive
...
four M7 fort proxies are the sole one-level exception set, leaving 85.3% of all
