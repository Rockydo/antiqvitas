...
For the current ledger, 1,017 of 1,272 placements (80.0%) use calibrated productive
...
All 1,204 regional-family placements render as non-special, repeatable guild
buildings with `guild_max_level`. The 68 named historic/civic or fort proxies
are the sole one-level exception set, leaving 94.7% of all
