...
For the current ledger, 319 of 454 placements (70.3%) use calibrated productive
...
four M7 fort proxies are the sole one-level exception set, leaving 85.5% of all
