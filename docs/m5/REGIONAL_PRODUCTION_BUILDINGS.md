...
A production-and-scale audit now counts every 1,778 M5/M7 start placement rather
than only these regional rows. It locks the actual layout at 77.4% productive
