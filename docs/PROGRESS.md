...
- 47 AD 1-200 currents now have distinct directed/delegated costs instead of
  ...
  fallback. Validator rejects duplicate packages.
...
- Independent review applied 127 definite repairs across engine kinds, sources,
  eponyms, formulas, spatial directions, collisions, and shortcut labels.
- `make validate` passes 170/170; paired smoke adds zero lines at fingerprint
  `3822fd3f52e7d55fea4473728eddd2d35510e38c16319fb452ecdd74c1e42cf2`.
...
- Added 12 directly illustrated city-market craft and service families with
  120 contested AD 1 placements. M5/M7 now has 1,032 placements: 78.2%
  productive and 93.4% scalable.

## 2026-07-23 - M5 third direct-art production pass

- Added 12 illustrated workshop families and 168 contested AD 1 market-hinterland
  placements across Europe, North Africa, and the Middle East. M5/M7 now has
  792 placements: 79.2% productive and 91.4% scalable.
...
- Added distinct direct 256px illustrations for State Annona Routes,
  Bureaucratic Customs, Foederati Provisioning, and Frontier Market Towns. Each
  has a retained source, exact master, BC7 DDS texture, ledger row, tree binding,
  and reviewed contact sheet.
- The generic material scenes claim no named city, ruler, empire, annona policy,
  ...
  weapon, inscription, writing, emblem, flag, or modern object. The direct
  advance migration now covers 59 of 250 advances.

Next: continue dedicated advance art, emphasizing Roman civic buildings, trade
goods, logistics, and period-appropriate city names alongside the source-led
Roman building layer.

## 2026-07-23 - Crisis civic-economy advance-icon batch

- Added distinct direct 256px illustrations for Crisis Trade Routes, Debased
  Currency Exchange, Military Supply Markets, and Fortified Warehouses. Each has
  a retained source, exact master, BC7 DDS texture, ledger row, tree binding,
  and reviewed contact sheet.
- The generic material scenes claim no named route, road, mint, city, polity,
  ruler, merchant, market, army, camp, fortress, port, currency reform, crisis
  event, person, animal, sign, standard, weapon, map, inscription, writing,
  flag, or modern object. The direct advance migration now covers 55 of 250
  advances.
...
- Added distinct direct 256px illustrations for Coin Exchange, Supply Columns,
  Frontier Patrols, and River Crossings. Each has a retained source, exact
  master, BC7 DDS texture, ledger row, tree binding, and reviewed contact sheet.
- The generic material scenes claim no named mint, ruler, city, empire,
  ...
  object. The direct advance migration now covers 47 of 250 advances.
...
- Added direct, ledger-bound illustrations for Imperial Archives, Standing
  Administration, and Provincial Governance. The planned binding rises to
  twenty individual advance illustrations.
- Reviewed the final 256px contact sheet. The assets use only blank archives,
  office tools, and measurement objects, without asserting a named archive,
  library, office, province, empire, law, tax, boundary, register, or ruler.
- `gmake validate` passed with twenty direct advance icons. The controlled
  vanilla/enabled `gmake smoke` pair reached the menu in both runs and found
  zero new mod-only error-log lines.
...
- Strabo's Balkan and Anatolian books, with a modern Anatolian synthesis, add
  50 named frames across the Adriatic, Danubian, Thracian, Macedonian, Galatian,
  Black-Sea, central, western, and southern-Anatolian zones. Each is a
  contested province-sized proxy, never an exact tribal polygon or language map.
- The ledger now has 470 reviewed selectors resolving 12,058 controlled
  locations across 292 mapped cultures; the catalogue rises from 264 to 314
  culture definitions. Population remains 230,000.000 thousand.
- The first runtime smoke exposed a duplicate `antq_liburnian` localization
  key with M7's unit type. The culture symbol was renamed
  `antq_liburnian_culture`; a second full validation and smoke were green with
  zero new error-log lines at 18:31 UTC.

Next: add a final independently reviewed corpus to cross the 350-culture
minimum, then repeat M4's full static and observer gate.
...
- Added a contested 22-location Kama-Perm/Belaya Permic proxy. The ledger now
  has 324 selectors, 12,011 locations, and 149 mapped cultures; the existing
  170-culture catalogue is retained.
- This extends the same early archaeological-linguistic reconstruction, not a
  later Komi/Udmurt identity, a fixed language boundary, or an
  institutional-continuity claim. Full validation and enabled-mod smoke are
...
- Added the lower-Yik/lower-Volga-Ural Sarmatian material-cultural proxy. The
  ledger now has 314 selectors, 11,747 locations, and 142 mapped cultures; the
  existing 165-culture catalogue is retained.
- The evidence supports a Sarmatian archaeological horizon but cautions against
  identifying that material culture with every named people or local community.
  This is therefore a contested regional frame, not a tribal border or a
  language map. Full validation and enabled-mod smoke are green, with zero new
  normalized error-log lines.
...
- Added generator-owned, locally schema-verified location modifiers for all
  nine M8 institution birthplaces, plus exact localized names and descriptions.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has eighty-one retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has seventy-seven retained masters.

Next: continue final-century M11 event-art coverage and source-led M5/M6 audit.

## 2026-07-20 - M11 Attila event illustration

- Added a reviewed, landscape-only Pannonian grassland image to the AD 434–453 current through the generated final-century event-image contract.
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has seventy-six retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has seventy-four retained masters.

Next: continue final-century M11 event-art coverage and source-led M5/M6 audit.

## 2026-07-20 - M11 Sack of Rome event illustration

- Added a reviewed, landscape-only central-Italian image to the AD 410 current through the generated final-century event-image contract.
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has seventy-three retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has seventy-one retained masters.

Next: continue final-century M11 event-art coverage and source-led M5/M6 audit.

## 2026-07-20 - M11 Faxian and Gupta Apogee event illustration

- Added a reviewed, landscape-only northern-Indian river-plain image to the AD 399–413 current through the generated fourth-century event-image contract.
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has seventy retained masters.

Next: continue M11 coverage into the final-century current set and source-led M5/M6 audit.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has sixty-eight retained masters.

Next: continue the M11 fourth-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Gwanggaeto the Great event illustration

- Added a reviewed, landscape-only Korean upland river-valley image to the AD 391–413 current through the generated fourth-century event-image contract.
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has sixty-seven retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has sixty-five retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has sixty-three retained masters.

Next: continue the M11 fourth-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Crete earthquake and tsunami event illustration

- Added a reviewed, landscape-only southern-Cretan coastal image to the AD 365 current through the generated fourth-century event-image contract.
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has sixty-two retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has sixty retained masters.

Next: continue the M11 fourth-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Council of Nicaea event illustration

- Added a reviewed, landscape-only Bithynian foothill-lakeshore image to the AD 325 current through the generated fourth-century event-image contract.
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has fifty-nine retained masters.
...
- `make validate` and enabled-mod smoke are green with zero new error-log lines; the M11 contact sheet now has fifty-seven retained masters.
...
- Added a reviewed, landscape-only north-Chinese loess-valley image to the AD
  291 War of the Eight Princes current through the generated third-century
...
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  ...
  contact sheet now has fifty-six retained event masters.

Next: continue the M11 fourth-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Diocletian and the Dominate event illustration

- Added a reviewed, landscape-only central-Balkan upland image to the AD 284
  Diocletian and the Dominate current through the generated third-century
  event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has fifty-five retained event masters.
...
- Added a reviewed, landscape-only western-Iranian river-margin image to the AD
  240 Manichaeism current through the generated third-century event-image
  contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has fifty-three retained event masters.

Next: continue the M11 later-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Crisis of the Third Century event illustration

- Added a reviewed, landscape-only central-Italian foothill image to the AD 235
  Crisis of the Third Century current through the generated third-century
  event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has fifty-two retained event masters.
...
- Added a reviewed, landscape-only north-Chinese river-valley image to the AD
  220 Three Kingdoms current through the generated third-century event-image
  contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has fifty retained event masters.
...
- Added a reviewed, landscape-only central-Italian lowland image to the AD 193
  Year of the Five Emperors / Severan Settlement current through the generated
  event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has forty-six retained event masters.
...
- Added a reviewed, landscape-only Danubian floodplain image to the AD 166-180
  Marcomannic Wars current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has forty-three retained event masters.

Next: continue the M11 later-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Daqin Embassy event illustration

- Added a reviewed, landscape-only South-China-Sea coastal image to the AD 166
  Daqin Embassy current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has forty-two retained event masters.
...
- Added a reviewed, landscape-only Mesopotamian river-margin image to the AD
  161 Verus' Parthian War current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has forty retained event masters.
...
- Added a reviewed, landscape-only inland-Chinese woodland image to the AD 142
  Celestial Masters current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has thirty-eight retained event masters.

Next: continue the M11 later-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Antonine Wall event illustration

- Added a reviewed, landscape-only northern-British moorland image to the AD
  142 Antonine Wall current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has thirty-seven retained event masters.
...
- Added a reviewed, landscape-only Central-Asian highland image to the AD 127
  Kushan Apogee current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has thirty-five retained event masters.

Next: continue the M11 later-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Hadrian's Wall event illustration

- Added a reviewed, landscape-only northern-British upland image to the AD 122
  Hadrian's Wall current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has thirty-four retained event masters.

Next: continue the M11 later-century art queue and source-led M5/M6 audit.

## 2026-07-20 - M11 Antioch earthquake event illustration

- Added a reviewed, landscape-only Orontes-valley image to the AD 115 Antioch
  earthquake current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has thirty-three retained event masters.
...
- Added a reviewed, non-literal Eastern Han scholarly-material image to the AD
  105 paper-standardization current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained M11
  contact sheet now has thirty-one retained event masters.
...
- Added a reviewed, non-literal Carpathian foothill-context image to the AD 85
  Dacian Wars current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained
  M11 contact sheet now has twenty-seven retained event masters.
...
## 2026-07-20 - M11 Mons Graupius event illustration

- Added a reviewed, landscape-only Caledonian upland-context image to the AD
  83 Mons Graupius current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained
  M11 contact sheet now has twenty-six retained event masters.

Next: continue the independent M11 art queue and source-led M5/M6 audit while
runtime-gated milestone checks remain deferred.

## 2026-07-20 - M11 Second Temple transformation event illustration

- Added a reviewed, landscape-only Judean environmental-context image to the
  AD 70 Second Temple transformation current through the generated event-image
  contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained
  M11 contact sheet now has twenty-five retained event masters.
...
- Added a reviewed, non-literal rain-wet Roman civic-context image to the AD
  68 Year of the Four Emperors current through the generated event-image
  contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained
  M11 contact sheet now has twenty-three retained event masters.

Next: continue the independent M11 art queue and source-led M5/M6 audit while
runtime-gated milestone checks remain deferred.

## 2026-07-20 - M11 Batavian Revolt event illustration

- Added a reviewed, non-literal Lower Rhine wetland-context image to the AD 69
  Batavian Revolt current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained
  M11 contact sheet now has twenty-two retained event masters.
...
- Added a reviewed, non-literal late-autumn Armenian frontier-context image to
  the AD 58 Rome-Parthia War over Armenia current through the generated
  event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines. The maintained
  M11 contact sheet now has twenty retained event masters.
...
- Added a reviewed, landscape-only southern British Channel coast image to the
  AD 43 Claudian Invasion current through the generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
- Added a reviewed, landscape-only Judean context image to the AD 30
  Christianity-founded current through the checked generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
## 2026-07-20 - M11 Florus and Sacrovir event illustration

- Added a reviewed, text-free Gaul river-and-market context image to the AD 21
  Florus and Sacrovir current through the checked generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
## 2026-07-20 - M11 Tacfarinas' War event illustration

- Added a reviewed, text-free North African frontier-context image to the AD 17
  Tacfarinas' War current through the checked generated event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
## 2026-07-20 - M11 Kushan Unification event illustration

- Added a reviewed, text-free Central Asian caravan-and-riders image to the
  AD 30 Kushan Unification formation current through the checked event-image
  contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
## 2026-07-20 - M11 Teutoburg Forest event illustration

- Added a reviewed, text-free rainy Germanic-forest column image to the AD 9
  Teutoburg Forest current through the checked event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
- Added the direct installed Faiyum location as a source-qualified, level-one
  `irrigation_systems` proxy for its continuing Roman-period canal-fed
  cultivation and reclamation.
- The bounded historic-site adapter passed `make validate`; enabled-mod smoke
  reached the menu with zero new error-log lines.
...
- Added a reviewed, text-free AD 9 early-imperial Chinese court illustration to
  the Xin Dynasty Crisis current through the checked event-image contract.
- The engine-sized BC7 texture was round-trip inspected; `make validate` and
  enabled-mod smoke are green with zero new error-log lines.
...
- Added Lucius Calpurnius Piso and Publius Sulpicius Quirinius as source-led
  Roman-world identities whose lives securely cross the AD 1 boundary.
- Later or undated duties are intentionally absent: no start office, command,
  governorship, census, residence, ability, or reconstructed genealogy is
  scripted.
...
- Added Xian, later Wulei Chanyu, as Wuzhuliu's source-qualified younger
  brother from the preserved early Tianfeng-era record.
- The later notice proves boundary-era survival only. Xian receives no AD 1
  chanyu/heir mechanic, office, date, residence, or extended genealogy.
...
- Created the repository on the EU5 installation drive at `<REPO_DIR>`.
...
- Confirmed the `--user_dir=` engine argument and relocated user data to
  `<EU5_USER_DIR>`; wired the repo with a G:-local junction.
...
## 2026-07-19 - M6 Augustan consular Fasti roster

- Added 36 named ordinary or July-suffect consuls from the AD 2-13
  *Fasti Capitolini* entries, while retaining the separate AD 1 records and
  avoiding existing Roman identities already covered by independent evidence.
- Every new record is court context only: no January AD 1 office, dated term,
  residence, marriage, parent graph, estate, ability, biography date, or later
  career is generated.
- `make validate` and the real-game `make smoke` are green, with the game
  reaching the menu and zero new `error.log` lines. The M6 roster is now 181
  source-led characters and 116 dynasties.
...
## 2026-07-19 - M6 AD 25-32 Fasti roster

- Added 27 named non-imperial ordinary or identified-suffect consuls from the
  AD 25-32 scholarly consular fasti. This is the final Fasti cohort usable
  under the normal age-threshold inference: an AD 33 consul could have been
  born during AD 1.
- Namesakes are kept separate only where the evidence distinguishes a later
  individual; all records remain court context only, with no start office,
  term, residence, genealogy, estate, ability, biography date, or career.
- `make validate` and the real-game `make smoke` are green; the game reached
  the menu and added zero `error.log` lines. The M6 roster is now 240
  source-led characters and 175 dynasties.
