...
`tools/generate_start_mirror.py` now emits 34 AD 1 country entries for roster
...
the capital-control states at AD 1. Unassigned land and the remaining 99
unmapped-capital polities remain the next M3 tasks.
