...
`tools/generate_start_mirror.py` now emits 57 AD 1 country entries for roster
...
generator has since expanded that set to 57 after geographic review. Unassigned
land and the remaining 76 unmapped-capital polities remain the next M3 tasks.
